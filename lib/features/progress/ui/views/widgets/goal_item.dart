...
import 'package:habitect/features/progress/ui/views/your_goals_detail_process_view.dart'
    as details;
...
class GoalItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, details.YourGoalsDetailProcessScreen.id);
      },
      child: Container(
